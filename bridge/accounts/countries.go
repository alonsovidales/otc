...
// Countries is ISO 3166-1 alpha-2 -> English short name: what the
// account's country of residence is validated against, and what the
// account page's country picker lists (GET /api/account/countries).
var Countries = map[string]string{
	...
	"KR": "Korea (South)", "KW": "Kuwait", "KG": "Kyrgyzstan", "LA": "Laos", "LV": "Latvia", "LB": "Lebanon",
